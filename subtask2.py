...
/*# sourceURL=ace/css/ace_editor.css */</style>
  ...
  <link rel="stylesheet" href="./subtask1.py_files/fonts.css">
  ...
  <script async="" src="./subtask1.py_files/gtm.js.download"></script><script>
  ...
  <script src="./subtask1.py_files/stub.min.js.download"></script>
  <script async="" src="./subtask1.py_files/cmp.js.download"></script>
  ...
  <link rel="stylesheet" href="./subtask1.py_files/playground.css">
  <!-- Global site tag (gtag.js) - Google Analytics -->

<script src="./subtask1.py_files/mode-python.js.download"></script><script src="./subtask1.py_files/theme-twilight.js.download"></script></head>
        ...
        <div class="nav-header-wrapper">
          <div class="nav-logo-title-wrapper">
            <a href="https://www.programiz.com/" target="_blank" class="nav-logo-link">
              <img id="nav-logo" src="./subtask1.py_files/logo-inverted.svg">
            </a>
          </div>
...
<rect width="40" height="40" fill="white"></rect>
    ...
    <div class="notification " id="notification" style="display:none;">
      <div class="check-icon-wrapper">
        <img src="./subtask1.py_files/check.svg" alt="check">
      </div>
...
<rect width="20" height="20" fill="white"></rect>
    ...
    <div class="wrapper" style="display: block;">
      <!-- Show sale banner if available -->
              <a id="sale-top-banner" class="sale-top-banner" rel="nofollow" href="https://programiz.pro/offer/cyber-monday?utm_source=top-banner-compiler&amp;utm_medium=banner&amp;utm_campaign=cybermonday-sale-24__top-banner-compiler__dec__60" title="Claim Discount" target="_blank" style="background-color: #FFE8D6; color: #25265E;">
          <!-- Desktop -->
          <div class="sale-top-banner__wrapper d-none d-md-flex">
            <!-- Left wrapper -->
            <div class="sale-top-banner__wrapper__left">
              <div class="sale-top-banner__sticker" style="background: linear-gradient(90deg, #F6D365 0%, #FDA085 74.28%); color: #1C2130;">
                CYBER MONDAY SALE              </div>
            </div>
            <!-- Center wrapper -->
            <div class="sale-top-banner__wrapper__center">
              <div class="sale-top-banner__title">Sale Ends Today: Secure 60% discount on lifetime access now!</div>
              <span class="sale-top-banner__cta">Claim My Discount</span>
            </div>
            <!-- Right wrapper -->
                          <div class="sale-top-banner__wrapper__right">
                <div class="sale-top-banner__title">
                  Sale ends in <span id="sale-time-countdown" data-end-time="2024-12-03T13:45:00+05:45" class="sale-top-banner__sale-timer">00d : 12hrs : 40mins : 56s</span>
                </div>
              </div>
                      </div>
          ...
          <div class="sale-top-banner__wrapper d-flex d-md-none">
            <!-- Left wrapper -->
            <div class="sale-top-banner__wrapper__left" style="background: linear-gradient(90deg, #F6D365 0%, #FDA085 74.28%); color: #1C2130;">
              <div class="sale-top-banner__sticker">CYBER MONDAY</div>
            </div>
            <!-- Center wrapper -->
            <div class="sale-top-banner__wrapper__center">
              <div class="sale-top-banner__title">Save 60% on PRO: Sale Ends Soon!</div>
              <div class="sale-top-banner__cta">Claim My Discount</div>
            </div>
          </div>
        </a>
            <div class="header">
          ...
          <div class="logo-wrapper">
            <h1 class="logo-title-wrapper">
              <a href="https://www.programiz.com/" target="_blank" class="logo-link">
                <img id="logo" src="./subtask1.py_files/logo-inverted.svg">
...
<path d="M11.5584 4.88281L6.44336 7.86781" stroke="white" stroke-width="1.77778" stroke-linecap="round" stroke-linejoin="round"></path>
        ...
        <div class="other-options-wrapper">
          ...
          <div class="mobile-top-bar-run-button run"><img src="./subtask1.py_files/play.svg" alt="run-icon"></div>
        </div>
      </div>
...
<path d="M11.5584 4.88281L6.44336 7.86781" stroke="white" stroke-width="1.77778" stroke-linecap="round" stroke-linejoin="round"></path>
        ...
        <div id="editor" class=" ace_editor ace-twilight ace_dark" style="font-family: &quot;Droid Sans Mono&quot;; font-size: 14px; line-height: 22px; height: 576.4px;"><textarea class="ace_text-input" wrap="off" autocorrect="off" autocapitalize="off" spellcheck="false" style="opacity: 0; font-size: 1px; height: 1px; width: 1px; top: 268px; left: 205px;"></textarea><div class="ace_gutter" aria-hidden="true" style="left: 0px; width: 50px;"><div class="ace_layer ace_gutter-layer ace_folding-enabled" style="height: 1e+06px; top: -62px; left: 0px; width: 50px;"><div class="ace_gutter-cell " style="height: 22px; top: 44px;">3<span style="display: none; height: 22px;" class="ace_fold-widget ace_start ace_closed"></span></div><div class="ace_gutter-cell " style="height: 22px; top: 66px;">4<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 22px; top: 88px;">5<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 22px; top: 110px;">6<span class="ace_fold-widget ace_start ace_open" style="height: 22px; display: none;"></span></div><div class="ace_gutter-cell " style="height: 22px; top: 132px;">7<span style="display: inline-block; height: 22px;" class="ace_fold-widget ace_start ace_open"></span></div><div class="ace_gutter-cell " style="height: 22px; top: 154px;">8<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 22px; top: 176px;">9<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 22px; top: 198px;">10<span style="display: none; height: 22px;" class="ace_fold-widget ace_start ace_open"></span></div><div class="ace_gutter-cell " style="height: 22px; top: 220px;">11<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 22px; top: 242px;">12<span style="display: inline-block; height: 22px;" class="ace_fold-widget ace_start ace_open"></span></div><div class="ace_gutter-cell " style="height: 22px; top: 264px;">13<span class="ace_fold-widget ace_start ace_open" style="height: 22px; display: inline-block;"></span></div><div class="ace_gutter-cell " style="height: 22px; top: 286px;">14<span style="display: none;"></span></div><div class="ace_gutter-active-line ace_gutter-cell " style="height: 22px; top: 308px;">15<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 22px; top: 330px;">16<span style="display: inline-block; height: 22px;" class="ace_fold-widget ace_start ace_open"></span></div><div class="ace_gutter-cell " style="height: 22px; top: 352px;">17<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 22px; top: 374px;">18<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 22px; top: 396px;">19<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 22px; top: 418px;">20<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 22px; top: 440px;">21<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 22px; top: 462px;">22<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 22px; top: 484px;">23<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 22px; top: 506px;">24<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 22px; top: 528px;">25<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 22px; top: 550px;">26<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 22px; top: 572px;">27<span class="ace_fold-widget ace_start ace_open" style="height: 22px; display: inline-block;"></span></div><div class="ace_gutter-cell " style="height: 22px; top: 594px;">28<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 22px; top: 616px;">29<span style="display: none;"></span></div></div></div><div class="ace_scroller" style="line-height: 22px; left: 49.8047px; right: 15px; bottom: 0px;"><div class="ace_content" style="top: -18px; left: 0px; width: 582.195px; height: 620.4px;"><div class="ace_layer ace_print-margin-layer"><div class="ace_print-margin" style="left: 676px; visibility: hidden;"></div></div><div class="ace_layer ace_marker-layer"><div class="ace_active-line" style="height: 22px; top: 264px; left: 0px; right: 0px;"></div></div><div class="ace_layer ace_text-layer" style="height: 1e+06px; margin: 0px 4px; top: -44px; left: 0px;"><div class="ace_line_group" style="height: 22px; top: 44px;"><div class="ace_line" style="height: 22px;"><span class="ace_identifier">s</span> <span class="ace_keyword ace_operator">=</span> <span class="ace_constant ace_numeric">0</span></div></div><div class="ace_line_group" style="height: 22px; top: 66px;"><div class="ace_line" style="height: 22px;"><span class="ace_identifier">m</span> <span class="ace_keyword ace_operator">=</span> <span class="ace_constant ace_numeric">0</span></div></div><div class="ace_line_group" style="height: 22px; top: 88px;"><div class="ace_line" style="height: 22px;"><span class="ace_identifier">x</span> <span class="ace_keyword ace_operator">=</span> <span class="ace_constant ace_numeric">0</span></div></div><div class="ace_line_group" style="height: 22px; top: 110px;"><div class="ace_line" style="height: 22px;"></div></div><div class="ace_line_group" style="height: 22px; top: 132px;"><div class="ace_line" style="height: 22px;"><span class="ace_keyword">while</span> <span class="ace_constant ace_language">True</span><span class="ace_punctuation">:</span></div></div><div class="ace_line_group" style="height: 22px; top: 154px;"><div class="ace_line" style="height: 22px;">    <span class="ace_comment"># Read input</span></div></div><div class="ace_line_group" style="height: 22px; top: 176px;"><div class="ace_line" style="height: 22px;">    <span class="ace_identifier">x</span> <span class="ace_keyword ace_operator">=</span> <span class="ace_support ace_function">int</span><span class="ace_paren ace_lparen">(</span><span class="ace_support ace_function">input</span><span class="ace_paren ace_lparen">(</span><span class="ace_string">"Enter a number (enter -1 to stop): "</span><span class="ace_paren ace_rparen">))</span></div></div><div class="ace_line_group" style="height: 22px; top: 198px;"><div class="ace_line" style="height: 22px;"></div></div><div class="ace_line_group" style="height: 22px; top: 220px;"><div class="ace_line" style="height: 22px;">    <span class="ace_comment"># Check if x is -1 to terminate</span></div></div><div class="ace_line_group" style="height: 22px; top: 242px;"><div class="ace_line" style="height: 22px;">    <span class="ace_keyword">if</span> <span class="ace_identifier">x</span> <span class="ace_keyword ace_operator">==</span> <span class="ace_keyword ace_operator">-</span><span class="ace_constant ace_numeric">1</span><span class="ace_punctuation">:</span></div></div><div class="ace_line_group" style="height: 22px; top: 264px;"><div class="ace_line" style="height: 22px;"><span class="ace_indent-guide">    </span>    <span class="ace_keyword">if</span> <span class="ace_identifier">n</span> <span class="ace_keyword ace_operator">==</span> <span class="ace_constant ace_numeric">0</span><span class="ace_punctuation">:</span></div></div><div class="ace_line_group" style="height: 22px; top: 286px;"><div class="ace_line" style="height: 22px;"><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span>    <span class="ace_identifier">m</span> <span class="ace_keyword ace_operator">=</span> <span class="ace_keyword ace_operator">-</span><span class="ace_constant ace_numeric">1</span></div></div><div class="ace_line_group" style="height: 22px; top: 308px;"><div class="ace_line" style="height: 22px;"><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span>    <span class="ace_identifier">a</span> <span class="ace_keyword ace_operator">=</span> <span class="ace_keyword ace_operator">-</span><span class="ace_constant ace_numeric">1</span></div></div><div class="ace_line_group" style="height: 22px; top: 330px;"><div class="ace_line" style="height: 22px;"><span class="ace_indent-guide">    </span>    <span class="ace_keyword">else</span><span class="ace_punctuation">:</span></div></div><div class="ace_line_group" style="height: 22px; top: 352px;"><div class="ace_line" style="height: 22px;"><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span>    <span class="ace_identifier">a</span> <span class="ace_keyword ace_operator">=</span> <span class="ace_identifier">s</span> <span class="ace_keyword ace_operator">/</span> <span class="ace_identifier">n</span></div></div><div class="ace_line_group" style="height: 22px; top: 374px;"><div class="ace_line" style="height: 22px;"><span class="ace_indent-guide">    </span>    <span class="ace_comment"># Output n, s, m, a</span></div></div><div class="ace_line_group" style="height: 22px; top: 396px;"><div class="ace_line" style="height: 22px;"><span class="ace_indent-guide">    </span>    <span class="ace_keyword">print</span><span class="ace_paren ace_lparen">(</span><span class="ace_string">f"n = </span><span class="ace_paren ace_lparen">{</span><span class="ace_identifier">n</span><span class="ace_paren ace_rparen">}</span><span class="ace_string">, s = </span><span class="ace_paren ace_lparen">{</span><span class="ace_identifier">s</span><span class="ace_paren ace_rparen">}</span><span class="ace_string">, m = </span><span class="ace_paren ace_lparen">{</span><span class="ace_identifier">m</span><span class="ace_paren ace_rparen">}</span><span class="ace_string">, a = </span><span class="ace_paren ace_lparen">{</span><span class="ace_identifier">a</span><span class="ace_paren ace_rparen">}</span><span class="ace_string">"</span><span class="ace_paren ace_rparen">)</span></div></div><div class="ace_line_group" style="height: 22px; top: 418px;"><div class="ace_line" style="height: 22px;"><span class="ace_indent-guide">    </span>    <span class="ace_keyword">break</span></div></div><div class="ace_line_group" style="height: 22px; top: 440px;"><div class="ace_line" style="height: 22px;"></div></div><div class="ace_line_group" style="height: 22px; top: 462px;"><div class="ace_line" style="height: 22px;">    <span class="ace_comment"># Update count and sum</span></div></div><div class="ace_line_group" style="height: 22px; top: 484px;"><div class="ace_line" style="height: 22px;">    <span class="ace_identifier">n</span> <span class="ace_keyword ace_operator">+=</span> <span class="ace_constant ace_numeric">1</span></div></div><div class="ace_line_group" style="height: 22px; top: 506px;"><div class="ace_line" style="height: 22px;">    <span class="ace_identifier">s</span> <span class="ace_keyword ace_operator">+=</span> <span class="ace_identifier">x</span></div></div><div class="ace_line_group" style="height: 22px; top: 528px;"><div class="ace_line" style="height: 22px;"></div></div><div class="ace_line_group" style="height: 22px; top: 550px;"><div class="ace_line" style="height: 22px;">    <span class="ace_comment"># Update minimum value if needed</span></div></div><div class="ace_line_group" style="height: 22px; top: 572px;"><div class="ace_line" style="height: 22px;">    <span class="ace_keyword">if</span> <span class="ace_identifier">n</span> <span class="ace_keyword ace_operator">==</span> <span class="ace_constant ace_numeric">1</span> <span class="ace_keyword">or</span> <span class="ace_identifier">x</span> <span class="ace_keyword ace_operator">&lt;</span> <span class="ace_identifier">m</span><span class="ace_punctuation">:</span></div></div><div class="ace_line_group" style="height: 22px; top: 594px;"><div class="ace_line" style="height: 22px;"><span class="ace_indent-guide">    </span>    <span class="ace_identifier">m</span> <span class="ace_keyword ace_operator">=</span> <span class="ace_identifier">x</span></div></div><div class="ace_line_group" style="height: 22px; top: 616px;"><div class="ace_line" style="height: 22px;"></div></div></div><div class="ace_layer ace_marker-layer"></div><div class="ace_layer ace_cursor-layer ace_hidden-cursors"><div class="ace_cursor" style="display: block; top: 264px; left: 155px; width: 8px; height: 22px; animation-duration: 1000ms;"></div></div></div></div><div class="ace_scrollbar ace_scrollbar-v" style="width: 20px; bottom: 0px;"><div class="ace_scrollbar-inner" style="width: 20px; height: 638px;">&nbsp;</div></div><div class="ace_scrollbar ace_scrollbar-h" style="display: none; height: 20px; left: 49.8047px; right: 15px;"><div class="ace_scrollbar-inner" style="height: 20px; width: 582.195px;">&nbsp;</div></div><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font: inherit; overflow: hidden;"><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font: inherit; overflow: visible;">הההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההה</div><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font-style: inherit; font-variant: inherit; font-stretch: inherit; font-size: inherit; line-height: inherit; font-family: inherit; font-optical-sizing: inherit; font-size-adjust: inherit; font-kerning: inherit; font-feature-settings: inherit; font-variation-settings: inherit; overflow: visible;"></div></div></div>
      </div>
      ...
      <div class="terminal-wrapper">
        ...
        <div id="terminal" class=" ace_editor ace-twilight ace_dark" style="font-family: &quot;Droid Sans Mono&quot;; font-size: 14px; line-height: 22px; height: 132px;"><textarea class="ace_text-input" wrap="off" autocorrect="off" autocapitalize="off" spellcheck="false" style="opacity: 0; font-size: 1px; height: 1px; width: 1px; top: 131px; left: 407px;"></textarea><div class="ace_gutter" aria-hidden="true" style="display: none; left: 0px; width: 42px;"><div class="ace_layer ace_gutter-layer ace_folding-enabled" style="height: 1e+06px; top: 0px; left: 0px; width: 42px;"><div class="ace_gutter-cell " style="height: 22px; top: 0px;">1<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 22px; top: 22px;">2<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 22px; top: 44px;">3<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 22px; top: 66px;">4<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 22px; top: 88px;">5<span style="display: none;"></span></div><div class="ace_gutter-cell ace_gutter-active-line " style="height: 22px; top: 110px;">6<span style="display: none;"></span></div></div></div><div class="ace_scroller" style="line-height: 22px; left: 0px; right: 0px; bottom: 0px;"><div class="ace_content" style="top: 0px; left: 0px; width: 647px; height: 176px;"><div class="ace_layer ace_print-margin-layer"><div class="ace_print-margin" style="left: 676px; visibility: hidden;"></div></div><div class="ace_layer ace_marker-layer"></div><div class="ace_layer ace_text-layer" style="height: 1e+06px; margin: 0px 4px; top: 0px; left: 0px;"><div class="ace_line_group" style="height: 22px; top: 0px;"><div class="ace_line" style="height: 22px;">Enter a number (enter -1 to stop): 5</div></div><div class="ace_line_group" style="height: 22px; top: 22px;"><div class="ace_line" style="height: 22px;">Enter a number (enter -1 to stop): -1</div></div><div class="ace_line_group" style="height: 22px; top: 44px;"><div class="ace_line" style="height: 22px;">n = 1, s = 5, m = 5, a = 5.0</div></div><div class="ace_line_group" style="height: 22px; top: 66px;"><div class="ace_line" style="height: 22px;"></div></div><div class="ace_line_group" style="height: 22px; top: 88px;"><div class="ace_line" style="height: 22px;"><span class="ace_comment ace_line ace_colons ace_dosbatch">=== Code Execution Successful ===</span></div></div><div class="ace_line_group" style="height: 22px; top: 110px;"><div class="ace_line" style="height: 22px;"><span class="ace_comment ace_line ace_colons ace_dosbatch">=== Session Ended. Please Run the code again ===</span></div></div></div><div class="ace_layer ace_marker-layer"></div><div class="ace_layer ace_cursor-layer ace_slim-cursors ace_hidden-cursors"><div class="ace_cursor" style="display: block; top: 110px; left: 407px; width: 8px; height: 22px; animation-duration: 1000ms;"></div></div></div></div><div class="ace_scrollbar ace_scrollbar-v" style="display: none; width: 20px; bottom: 0px;"><div class="ace_scrollbar-inner" style="width: 20px; height: 132px;">&nbsp;</div></div><div class="ace_scrollbar ace_scrollbar-h" style="display: none; height: 20px; left: 0px; right: 0px;"><div class="ace_scrollbar-inner" style="height: 20px; width: 647px;">&nbsp;</div></div><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font: inherit; overflow: hidden;"><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font: inherit; overflow: visible;">הההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההה</div><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font-style: inherit; font-variant: inherit; font-stretch: inherit; font-size: inherit; line-height: inherit; font-family: inherit; font-optical-sizing: inherit; font-size-adjust: inherit; font-kerning: inherit; font-feature-settings: inherit; font-variation-settings: inherit; overflow: visible;"></div></div></div>
      </div>
  ...
  <!-- The use of the cloudflare cdn for all external libraries is intential. We are trying to reduce the number
         of DNS lookups.
    -->
  <script defer="" src="./subtask1.py_files/socket.io.min.js.download"></script>
  <script defer="" src="./subtask1.py_files/jquery.min.js.download"></script>

  <script defer="" src="./subtask1.py_files/ace.js.download"></script>
  <script defer="" src="./subtask1.py_files/mousetrap.min.js.download"></script>
  <script defer="" src="./subtask1.py_files/final.js.download"></script>

  <!-- Google Tag Manager (noscript) -->
  <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-TKXT7MH" height="0" width="0"
      style="display:none;visibility:hidden"></iframe></noscript>
  <!-- End Google Tag Manager (noscript) -->
<script defer="" src="./subtask1.py_files/vcd15cbe7772f49c399c6a5babf22c1241717689176015" integrity="sha512-ZpsOmlRQV6y907TI0dKBHq9Md29nnaEIPlkf84rnaERnq6zvWvPUqr2ft8M1aS28oN72PdrCzSjY4U6VaAw1EQ==" data-cf-beacon="{&quot;rayId&quot;:&quot;8ebd99050cf65c16&quot;,&quot;version&quot;:&quot;2024.10.5&quot;,&quot;r&quot;:1,&quot;token&quot;:&quot;0a465ad039704d1f9760ad556f6f3cdd&quot;,&quot;serverTiming&quot;:{&quot;name&quot;:{&quot;cfExtPri&quot;:true,&quot;cfL4&quot;:true,&quot;cfSpeedBrain&quot;:true,&quot;cfCacheStatus&quot;:true}}}" crossorigin="anonymous"></script>
